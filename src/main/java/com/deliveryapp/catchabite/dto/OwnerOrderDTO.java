...
public class OwnerOrderDTO {
	...
	private Integer orderTotalPrice;     // 총 결제금액(또는 총 주문금액)
	private Integer deliveryFee;         // 배달비(있다면)
	private Integer discountPrice;       // 할인(있다면)
	...
	public static class OptionDTO {
		...
		private Integer menuOptionPrice;    // 스냅샷
	}
}
